...
const SettingsScreen: React.FC<SettingsScreenProps> = ({ navigation }) => {
    ...
    const scenariosCount = useAppSelector(state => state.scenarios.scenarios.length);
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.settingRow}>
                        ...
                        <Switch
                            ...
                            trackColor={{ false: colors.light.border, true: colors.primary.main }}
                            thumbColor="#FFFFFF"
                        />
                    </View>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => Linking.openURL('https://github.com/GrihmLord/PREDICTIQ')}
                    >
