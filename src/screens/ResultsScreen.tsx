                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.factorsContainer}>
                        ...
                        <View style={styles.factorColumn}>
                            <Text style={[styles.factorColumnTitle, { color: colors.success.high }]}>
                                Positive Factors
                            </Text>
                            {positiveFactors.map((factor, index) => (
                                <View key={index} style={styles.factorItem}>
                                    <Text style={styles.factorName}>{factor.factor}</Text>
                                    <Text style={[styles.factorImpact, { color: colors.success.high }]}>
                                        +{factor.impact}%
                                    </Text>
                                </View>
                            ))}
                        ...
                        {/* Negative Factors */}
                        <View style={styles.factorColumn}>
                            <Text style={[styles.factorColumnTitle, { color: colors.danger.high }]}>
                                Risk Factors
                            </Text>
                            {negativeFactors.map((factor, index) => (
                                <View key={index} style={styles.factorItem}>
                                    <Text style={styles.factorName}>{factor.factor}</Text>
                                    <Text style={[styles.factorImpact, { color: colors.danger.high }]}>
                                        {factor.impact}%
                                    </Text>
                                </View>
                            ))}
                    ...
                    <View style={styles.netImpactCard}>
                        ...
                        <Text
                            style={[
                                ...
                                { color: netImpact >= 0 ? colors.success.high : colors.danger.high },
                            ]}
                        >
