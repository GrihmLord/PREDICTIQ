...
export const DefconStatus: React.FC<DefconStatusProps> = ({ level, description }) => {
    ...
    const getDefconColor = (l: number) => {
        switch (l) {
            case 1: return colors.danger.high; // Red
            case 2: return colors.chart.orange; // Orange
            case 3: return colors.warning.high; // Yellow/Amber
            case 4: return colors.success.high; // Green
            case 5: return colors.chart.blue; // Blue
            default: return colors.chart.blue;
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <Animated.View style={[
                ...
                <Text style={[styles.defconTitle, { color: activeColor }]}>DEFCON {level}</Text>
